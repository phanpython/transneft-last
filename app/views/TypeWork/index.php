                        ...
                        <input type="text" hidden name="typical_work_name-{{i}}" value="{{typical_work.name}}">
                            <label for="check_typical_work_{{typical_work.typical_work_id}}" class="typical-work__main">
                                ...
                                {% if current_typical_work.typical_work_id == typical_work.typical_work_id %}
                                    {% set fl = true %}
                                    <input id="check_typical_work_{{typical_work.typical_work_id}}" name="typical_work-{{i}}" checked class="typical-work__checkbox" type="checkbox">
                                    </label>
                                ...
                                {% endfor %}
                                {% if fl == false %}
                                <input id="check_typical_work_{{typical_work.typical_work_id}}" name="typical_work-{{i}}" class="typical-work__checkbox" type="checkbox">
                                </label>
